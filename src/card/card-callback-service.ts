...
export function analyzeCardCallback(data: unknown): CardCallbackAnalysis {
  ...
  const spaceType =
    typeof record?.spaceType === "string" ? record.spaceType.trim().toLowerCase() : "";
