...
export const questionTargetSchema = {
  ...
  description:
    ...
    "Group targets require an explicit respondentUserIds list; collect one response per person and resume once all respond or after 5 minutes. " +
    "The initiating user's next message or question invalidates this form, as with current-user questions.",
  properties: {
