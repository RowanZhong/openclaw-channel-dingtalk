...
const topicExample = { id: "demo-topic", enabled: true, scope: "all", targets: [], targetRows: [],
  name: "导出PDF的操作方法", description: "询问文档导出PDF的操作步骤", examples: "怎么导出PDF？\n在哪下载PDF版本？",
  exclusions: "报错、权限不足、要求代操作或其他问题", action: "auto", text: "请按你们产品的真实步骤填写操作说明或文档链接。",
  expires: Date.now() + 3600000, cooldownMinutes: 30, hours: "1", cooldown: "30", sample: "怎样把文档保存为PDF格式？" };
settings.topics = { enabled: true, mode: "only", revision: 1, rules: [topicExample] };
views.home = buildView("home", previewState, {});
for (const page of ["topics", "topic-mode", "topic-manage", "topic-detail", "topic-new", "topic-definition", "topic-action", "topic-trial", "topic-limits", "topic-review"])
  views[page] = buildView(page, previewState, { id: topicExample.id, wizard: topicExample });
views["topic-trial-result"] = buildView("topic-trial", previewState, { wizard: { ...topicExample,
  trial: { outcome: "match", reason: "matched", ruleIds: [topicExample.id], coversWholeMessage: true } } });
