...
describe('send-service media branches', () => {
    ...
    it('sendMessage routes direct session voice replies through proactive media API instead of sendBySession webhook', async () => {
    ...
    it('sendMessage routes group session voice replies through proactive media API instead of sendBySession webhook', async () => {
        mockedUploadMedia.mockResolvedValueOnce({
